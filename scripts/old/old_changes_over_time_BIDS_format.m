...
outdir = fullfile(repodir, 'data', 'group_level');
cd(repodir);
...
time1 = fmri_data(filenames(fullfile('data', 'subject level', '*', 'con_0003.img')));
time2 = fmri_data(filenames(fullfile('data', 'subject level', '*', 'con_0007.img')))
...
% drop the P with bad bios timing / technical error
